...
type VcsDelegateBindings<TContext> = {
...
type VcsDelegateMethodName = keyof VcsDelegateBindings<PluginRuntimeContext>;
...
type VcsDelegateAssignments<TContext> = {
